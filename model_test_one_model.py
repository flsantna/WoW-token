import numpy as np
from config import list_key, total_epochs, look_back, window
...
if __name__ == '__main__':
    ...
    if test_type == 0:
        ...
        for key in range(len(list_key)):
            proc = Processing()
            model = LSTM_Model(window=window, look_back=look_back)
            model_load_path = 'model/w{}/lb{}_last_trainned_with_{}_total_epochs{}'\
            ...
            all_predicts.append([pred_y_unit, rmse_2.numpy()])
