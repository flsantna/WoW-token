import numpy as np
import config
from config import list_key, total_epochs, look_back, window, configs_test, predict_choice
...
# and calculating it's RMSE (Reduced Mean Squared Error).
        ...
        for key in range(len(list_key)):
            ...
            all_predicts.append([pred_y_unit, rmse_2.numpy(), predict_days[predict_choice]])
